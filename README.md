...
This project will focus on analyzing COVID-19 deaths via machine learning algorithms in Python, specifically SciKitLearn, to analyze both the logistic and linear regression of death rate data attained from kaggle. The data analyzed using Python only extends from early January 2020 to late February 2020. 
